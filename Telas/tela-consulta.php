...
<body style="background-color: #f2f2f2;">
	...
	<?php
		...
		$cartsus_pessoa = $_GET['num_cartao'];
		...
		<?php while ($dados = mysqli_fetch_array($tabela_pessoa)){ ?> 
			<br>
			<div class="row">
			<div class="card-panel grey lighten-2 col s12 m12 l6 offset-l3 ">
	...
	<div class="row">
		<div class="col s12 m12 l6 offset-l3">
			...
			<center><a href="pagina-inicial.php" style="border-radius: 20px;" class="waves-effect waves-light btn green darken-2"><i class="material-icons left">undo</i>Voltar</a></center>
		</div>
